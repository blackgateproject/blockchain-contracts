...
export default async function () {
  ...
  const RSAAccumulatorVerifierCNTRT = await deployContract(contractArtifactName, [
    modulus,
    accumulatorPost,
  ]);
  ...
  console.log("RSAAccumulatorVerifier deployed to:", RSAAccumulatorVerifierCNTRT.target);
